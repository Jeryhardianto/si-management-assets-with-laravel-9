                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name',$role->name) }}" class="form-control @error('name')
                            is-invalid                                
                            @enderror">
                            @error('name')
                                              ...
                                              <div class=" col-sm-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-checkbox">
                                                        ...
                                                        <input class="custom-control-input" id="{{ $permission }}" name="permissions[]" type="checkbox" value="{{ $permission }}" {{ in_array($permission,old('permissions', $permissionsChecked)) ? "checked" : null  }}>
