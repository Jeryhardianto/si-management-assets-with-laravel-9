                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="date" id="tanggalkembali" name="tanggalkembali" value="{{ old('tanggalkembali') }}"
                                    class="form-control @error('tanggalkembali') is-invalid @enderror col-4" placeholder="Masukan tanggalkembali">
