...
<head>
    ...
    <title>Slip Pengembalian - {{ $kembali->id_transaksi }}</title>
...
<body>
    <h3 class="text-center"><u>SLIP PENGEMBALIAN</u></h3>
    <div class="container mt-5">
        <table class="table">
            <tr>
                <td width="30%">Nomor Transaksi</td>
                <td width="70%">: {{ $kembali->id_transaksi }}</td>
            </tr>
            <tr>
                <td>Nama Penerima</td>
                <td>: {{ $kembali->petugas->name }}</td>
            </tr> 
            <tr>
                <td>Tanggal Pengembalian</td>
                <td>:
                    @php
                        $date = date_create($kembali->tanggal_pengembalian);
        ...
        <h4 class="text-center"><u>DAFTAR ASSET YANG KEMBALIKAN</u></h4>
